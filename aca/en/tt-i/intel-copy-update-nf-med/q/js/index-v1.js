$(document).ready(function() {
    ...
    $(".q1-btn").click(function(e){
        const elText = e.target.innerHTML;
        if(elText == "Yes"){
            $('.pNumber').text('(833) 203-2781')
            $('.tapTocall').attr("href", 'tel:+18332032781'); 
        }
    })
    ...
    function callshaper(fname, lname, phone, trusted){
        const d = new Date()
        const getDate = d.toISOString().split('T')[0]
        ...
        fetch(`https://hook.us1.make.com/md5npliutajmr7nrfms2wtokceb1g70a?FirstName=${fname}&LastName=${lname}&PhoneNumber=${phone}&xxTrustedFormCertUrl=${trusted}&InquiryDate=${getDate}&ExpressConsent=1`, options)
