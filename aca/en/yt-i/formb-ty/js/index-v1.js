$(document).ready(function() {
    ...
    function working() {
        ...
        if (next.length) {
            ...
            $('.progress1 > span').text('100% Complete');
            $('.progress1 .bar span').css({ width: '100%' });
        }
    ...
    function next(e) {
        ...
        parent.fadeOut(function() {
            if (next.length) {
                ...
                $('.progress1 > span').text(Math.round(progress) + '% Complete');
                $('.progress1 .bar span').css({ width: progress + '%' });
